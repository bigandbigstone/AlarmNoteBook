package com.example.AlarmNoteBook.DBoperation;

import android.content.ContentValues;
import android.provider.BaseColumns;

import com.example.AlarmNoteBook.Constants;
import com.example.AlarmNoteBook.common.ColumnContacts;
import com.example.AlarmNoteBook.common.DBTemplate;
...
public class EventDBO {
    ...
    //设置为单例模式，其他类均是此方法
    private static EventDBO mEventDBO = new EventDBO();

    private EventDBO() {
    }

    public static EventDBO getInstance() {
        return mEventDBO;
    }
