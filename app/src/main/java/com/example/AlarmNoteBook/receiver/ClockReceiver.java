package com.example.AlarmNoteBook.receiver;
...
import com.example.AlarmNoteBook.ui.activity.ClockActivity;
import com.example.AlarmNoteBook.util.WakeLockUtil;

/**
 * @see com.example.AlarmNoteBook.service.ClockService
 */
public class ClockReceiver extends BroadcastReceiver {
    ...
    private void postToClockActivity(Context context, Intent intent) {
        ...
        Event event = mEventDBO.findById(intent.getIntExtra(EXTRA_EVENT_ID, -1));
        if (event == null) {
            return;
        }
